...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMinimumSize(QSize(950, 750));
        MainWindow->setMaximumSize(QSize(950, 750));
        ...
        layoutWidget = new QWidget(PortControlsBox);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(11, 26, 190, 141));
        ...
        comboData = new QComboBox(layoutWidget);
        ...
        comboStop = new QComboBox(layoutWidget);
        ...
        labelParity = new QLabel(layoutWidget);
        ...
        lineEdit = new QLineEdit(PlotControlsBox);
        ...
        gridGroupBox->raise();
        PortControlsBox->raise();
        plot->raise();
        textEdit_UartWindow->raise();
        PlotControlsBox->raise();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        savePNGButton->setText(QCoreApplication::translate("MainWindow", "\344\277\235\345\255\230\345\275\223\345\211\215\350\247\206\345\233\276", nullptr));
